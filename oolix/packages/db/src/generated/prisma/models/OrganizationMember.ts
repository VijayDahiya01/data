...
export type OrganizationMemberWhereInput = {
  ...
  status?: Prisma.EnumMembershipStatusFilter<"OrganizationMember"> | $Enums.MembershipStatus
...
export type OrganizationMemberWhereUniqueInput = Prisma.AtLeast<{
  orgId_userId_role?: Prisma.OrganizationMemberOrgIdUserIdRoleCompoundUniqueInput
  AND?: Prisma.OrganizationMemberWhereInput | Prisma.OrganizationMemberWhereInput[]
  OR?: Prisma.OrganizationMemberWhereInput[]
  NOT?: Prisma.OrganizationMemberWhereInput | Prisma.OrganizationMemberWhereInput[]
  orgId?: Prisma.UuidFilter<"OrganizationMember"> | string
...
export type OrganizationMemberScalarWhereWithAggregatesInput = {
  ...
  status?: Prisma.EnumMembershipStatusWithAggregatesFilter<"OrganizationMember"> | $Enums.MembershipStatus
...
export type OrganizationMemberOrgIdUserIdRoleCompoundUniqueInput = {
  orgId: string
  userId: string
  role: $Enums.Role
}
...
export type OrganizationMemberOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"orgId" | "userId" | "role" | "status" | "invitedAt" | "updatedAt", ExtArgs["result"]["organizationMember"]>
...
export interface OrganizationMemberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const organizationMemberWithOrgIdOnly = await prisma.organizationMember.findMany({ select: { orgId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many OrganizationMembers and only return the `orgId`
   * const organizationMemberWithOrgIdOnly = await prisma.organizationMember.createManyAndReturn({
   *   select: { orgId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more OrganizationMembers and only return the `orgId`
   * const organizationMemberWithOrgIdOnly = await prisma.organizationMember.updateManyAndReturn({
   *   select: { orgId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface OrganizationMemberFieldRefs {
  ...
  readonly status: Prisma.FieldRef<"OrganizationMember", 'MembershipStatus'>
